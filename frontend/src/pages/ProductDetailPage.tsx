      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="md:sticky md:top-4 self-start">
            <div className="aspect-square max-h-[500px] rounded-2xl overflow-hidden bg-neutral-100 mb-4">
          ...
          <div>
            ...
            {product.averageRating !== undefined && product.averageRating > 0 && (
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-neutral-600">
                  {product.averageRating} ({product.totalReviews || 0} đánh giá)
                </span>
              </div>
            )}
            ...
            <div className="flex gap-4 mb-8">
              ...
              >
                {isFavorite ? <HiHeart className="w-6 h-6" /> : <HiOutlineHeart className="w-6 h-6" />}
              </button>
              <button onClick={handleShare} className="btn btn-secondary px-4" title="Chia sẻ">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-2 text-neutral-600">
                ...
                Miễn phí giao hàng cho đơn trên 750.000đ
              </div>
              <div className="flex items-center gap-2 text-neutral-600">
                <span className="text-lg">🌸</span>
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-16">
            <h2 className="font-heading text-2xl mb-8">Có Thể Bạn Sẽ Thích</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {relatedProducts.map(item => (
                <Link key={item._id} to={`/products/${item._id}`} className="group">
                  ...
                  <p className="text-primary font-semibold">{(item.price || 0).toLocaleString('vi-VN')}đ</p>
                </Link>
              ))}
            </div>
          </section>
